...
//    debug('registerCollections() graph:', graph);
//    debug('registerCollections() collections:', collections);
...
//            console.log('getCollections cols:', cols);
...
//            debug('docCollection:', docCollection);
//            debug('edgeCollection:', edgeCollection);
            next(null, {
...
//            }) === undefined && v.adapter.query.hasSchema !== 'graph';
          });
...
//            if (currentNamedGraphs[k] === undefined && v.adapter.query.hasSchema === 'graph') {
...
//    debug('STACK:', (new Error('stack')).stack);
...
//    debug('collection:', this.collections[collection]);
